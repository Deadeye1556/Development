...
3. Grep/glob for existing patterns (imports, navigation structure, theme usage) before writing
4. Write screens, components, navigation, and styles directly in your domain files
...
What was built: [summary of screens, components, and navigation changes]
Tests or verification with actual output: [results, or BLOCKED + flagged dependency]
